...
public class DBservices
{
    ...
    //--------------------------------------------------------------------------------------------------
    // This method read Users by email and password
    //--------------------------------------------------------------------------------------------------
    ...
    public List<User> ReadAllUsers()
    {
        ...
        cmd = CreateReadCommandSP("spGetAllUsers", con);
    ...
    //--------------------------------------------------------------------------------------------------
    // This method read vacation in each city by month
    //--------------------------------------------------------------------------------------------------
    public Object ReadAvgVacaiPrice(int month)
    {
            ...
            cmd = CreateReadAvgPricCommandSP("spGetAvgPrice", con, month);
            ...
            try
            {
                ...
                listObjs.Add(new
                {
                    ...
                    price = Convert.ToDouble(dataReader["avgPrice"])
            });
                }
                return listObjs;
            }
    ...
    // Create the Read SqlCommand
    //---------------------------------------------------------------------------------
    private SqlCommand CreateReadAvgPricCommandSP(String spName, SqlConnection con, int month)
    {
